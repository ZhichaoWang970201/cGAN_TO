...
class Data_Loader():
    ...
    def load_wheel(self):
        transforms = self.transform(False, True, False, False)
        dataset = dsets.ImageFolder(self.path+'/wheel', transform=transforms)
        return dataset
    ...
    def loader(self):
        ...
        elif self.dataset == 'wheel':
            dataset = self.load_wheel()

...
def get_parameters():
    ...
    #parser.add_argument('--g_lr', type=float, default=0.00003)
    ...
    #parser.add_argument('--pretrained_model', type=int, default=127800)

    # Misc
    parser.add_argument('--train', type=str2bool, default=True)
    parser.add_argument('--parallel', type=str2bool, default=False)
    parser.add_argument('--dataset', type=str, default='cifar', choices=['lsun', 'celeb', 'wheel'])
